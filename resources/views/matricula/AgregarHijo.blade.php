...
@section('content')
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="estudiante">
            ...
            {!!Form::open(['route'=>['Registrar.NuevoHijo',$id], 'method'=>'POST', 'onsubmit'=>"waitingDialog.show('Guardando Espere... ',{ progressType: 'info'});setTimeout(function () {waitingDialog.hide();}, 3000);"])!!}

            <div class="container panel panel-body">
                @include('alertas.errores')
                @include('alertas.flash')
                @include('matricula.formularios.NuevoHijoFormulario')
