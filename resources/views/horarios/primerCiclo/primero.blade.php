<div class="container panel">
    <h2>Horario de Clases Primer Grado.</h2>
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <td>Estudios Sociales</td>
            <td>Lectura</td>
            <td>Art&iacute;stica</td>
        </tr>
        <tr>
            <td>11:30am - 12:00md</td>
            <td>Inform&aacute;tica</td>
            <td>Ortograf&iacute;a</td>
            <td>Moral y C&iacute;vica</td>
            <td>Lectura</td>
            <td>Educaci&oacute;n en la Fe</td>
        </tr>
        </tbody>
    </table>
</div>
