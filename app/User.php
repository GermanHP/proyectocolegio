...
class User extends Model {
    ...
    protected $fillable = ['id', 'nombre', 'apellido', 'genero', 'email', 'password', 'idTipousuario', 'resetPassword', 'remember_token', 'deleted_at', 'usuarioMoodle', 'passwordMoodle', 'TokenPushNotification'];
