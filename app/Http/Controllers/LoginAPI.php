    ...
    public function LoginUser(Request $request)
    {
        ...
        try {
            ...
            if($user->idTipousuario ==2){
                ...
                if(!$bloqueado->UsuariosBloqueados($user->id)){
                    ...
                    $usuario = User::where('id',$user->id)->with('padredefamilia',
                        ...
                        "padredefamilia.padreestudiantes.estudiante.notas.tiponotum",
                        "padredefamilia.padreestudiantes.estudiante.notas.periodo",
                    ...
                    return response()->json(['ErrorCode' => '4', 'msg' => 'Bloqueo por insolvencia']);
                }
