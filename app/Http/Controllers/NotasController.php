...
class NotasController extends Controller
{
    ...
    public function NotasGenerales ($id){
        $idM = $id;
        $materia = Materiagrado::where('id', $id)->with(['materium', 'gradoseccion.matriculas.estudiante.user' => function ($query) {
    ...
    public function GuarDarNotasGenerales($id,Request $request){
